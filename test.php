    ...
    <div class="exerciseContainer">
      <div class="exerciseWrapper2">
        <?php
          ...
          $sql = "SELECT DISTINCT exerciseName FROM ft_users_exercise_plan WHERE usersId='$usersId' LIMIT 20;";
          ...
          if (!mysqli_stmt_prepare($stmt, $sql)) {
            echo "SQL statement failed!";
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                echo '<div class="exerciseColContainer">
                        <a href="tracker?exercise='.$row['exerciseName'].'">
                          <div class="exerciseColBtn"><i class="material-icons">keyboard_arrow_right</i></div>
                          <div class="exerciseColText">
