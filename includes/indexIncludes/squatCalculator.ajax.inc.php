<?php
  if (isset($_POST['weight'])) {
    ...
    if (empty($weight) || empty($userBodyweight)) {
      ...
      echo "<p>You can squat <b>".$usersStrengthRatio."</b> times your bodyweight!</p>";
      echo "<h4>Here are the strength standards for the squat:</h4>";
      //Start of Table
      ...
      $sql = "SELECT * FROM ft_squat_comparison WHERE gender='$gender'AND (bodyweight='$userBodyweightMinus5' OR bodyweight='$userBodyweight' OR bodyweight='$userBodyweightPlus5')";
